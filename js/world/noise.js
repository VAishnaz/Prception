// Shared noise, both flavours:
//  - NOISE_GLSL: Ashima 3D simplex + fbm, prepended to any shader that morphs
//  - makeNoise2D/fbm2: tiny CPU value-noise for terrain heightfields
...
export function fbm2(noise, x, y, oct = 4) {
  let f = 0, a = 0.5, tot = 0;
